...
st.markdown('* __Journal where you can document how you feel')
st.markdown('* __Essentials where you can find the many mental health services CUNY and the government provides')
